...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="department_admin.php">View Result</a></li>
         <li><a href="department_admin.php?logout='1'">logout</a></li>
  ...
  <table class="table">
    <form method="post" action="department_admin.php" >
    
     <label>please select to calculate marks</label><br>
