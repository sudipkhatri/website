  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li ><a href="dashboardadmin.php">Add Admin</a></li>
...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="addadmin2.php">Add department admin</a></li>
        <li><a href="view_result.php">View Result</a></li>
        <li><a href="addstudent.php?logout='1'">logout</a></li>
      </ul><br>
    </div>
    <br>
  ...
  <form method="post" action="addstudent.php">
    ...
    <div class="input-group">
      ...
      <input type="text" name="user_type" id="user_type" value="user" readonly>
    </div>
    <div class="input-group">
